...
Todos os exercícios foram desenvolvidos utilizando a linguagem Python na plataforma Google Colab. As bases de dados utilizadas em cada exemplo estão disponíveis na pasta [data_base](data_base/).
...
<a href="data_base/credit_data.csv" download="credit_data.csv">credit_data.csv</a>
