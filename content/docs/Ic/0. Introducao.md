...
Todos os exercícios foram desenvolvidos utilizando a linguagem Python na plataforma Google Colab. As bases de dados utilizadas em cada exemplo estão disponíveis no [Google Drive](https://drive.google.com/drive/folders/1etlpnlKX2tkvhaDQagjEpdxPloJee_0c?usp=sharing).
